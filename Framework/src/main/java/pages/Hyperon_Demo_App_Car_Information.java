...
public class Hyperon_Demo_App_Car_Information extends BasePage
{
	...
	private By MakeElem = By.xpath("//SELECT[@ng-model='ctrl.vehicle.makeId']");

	private By ModelElem = By.xpath("//SELECT[@ng-model='ctrl.vehicle.modelId']");

	private By Production_YearElem = By.xpath("//SELECT[@ng-model='ctrl.vehicle.productionYear']");

	private By TypeElem = By.xpath("//SELECT[@ng-model='ctrl.vehicle.typeId']");
